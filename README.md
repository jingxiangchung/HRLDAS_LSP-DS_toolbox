...
3. ldasout_fix.sh, script to fix HRLDAS LSP-DS output files so that they can be read correctly by Climate Data Operators and GrADS. [Note: ldasout_fix.sh behaves slowly because it is trying to correct everything. Thus, using this script is not recommended and will not be updated in future]
